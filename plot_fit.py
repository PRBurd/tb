...
def plot_gradients(source_param,jet_param):
	...
	plt.savefig(f'./paper_plots_test/{Name[source_param]}+_{jet_param}.pdf',dpi=500)
	plt.close()
...
np.save('./numpy_arrays/l0_test.npy',l)
np.save('./numpy_arrays/s0_test.npy',s)
np.save('./numpy_arrays/sd0_test.npy',sd)
